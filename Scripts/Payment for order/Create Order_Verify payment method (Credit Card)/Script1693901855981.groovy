...
WebUI.setText(findTestObject('Orders_Alpha_CreateNew/Page_SellerCloud_Orders/input_Phone_BillingAddssPhoneField'), '09007860112')
...
WebUI.setText(findTestObject('Orders_Alpha_CreateNew/Page_SellerCloud_Orders/input_Quantity_ForOrder_ProductQty'), '1')

WebUI.click(findTestObject('Orders_Alpha_CreateNew/Page_SellerCloud_Orders/input_Quantity_btnAddItemToOrder'))

WebUI.click(findTestObject('Extras_CreateOrder/add_ProductPriceinOrder'))

'add product amount'
WebUI.setText(findTestObject('Extras_CreateOrder/add_ProductPriceinOrder'), '5')
...
WebUI.selectOptionByValue(findTestObject('Orders_Alpha_CreateNew/Page_Payment_infor/select_Payment_mthd_for_payment'), '1', 
    false)

WebUI.click(findTestObject('Extras_CreateOrder/SelectCardType'))

WebUI.selectOptionByValue(findTestObject('Extras_CreateOrder/SelectCardType'), '2', false)

WebUI.click(findTestObject('Extras_CreateOrder/InputCardNumbe'))

WebUI.setText(findTestObject('Extras_CreateOrder/InputCardNumbe'), '12587459632189')

WebUI.click(findTestObject('Extras_CreateOrder/Select_expiresDateYr'))

WebUI.selectOptionByValue(findTestObject('Extras_CreateOrder/Select_expiresDateYr'), '2025', false)

WebUI.click(findTestObject('Extras_CreateOrder/InputCardHolderName'))

WebUI.setText(findTestObject('Extras_CreateOrder/InputCardHolderName'), 'DummyTT')

WebUI.click(findTestObject('Orders_Alpha_CreateNew/Page_Payment_infor/input_Refresh_Totals_btnCreateOrder_SaveOrder'))

WebUI.waitForPageLoad(5)

WebUI.getText(findTestObject('Page_SellerCloud_Login/Page_After_Order_create/span_get ordernumber'), FailureHandling.STOP_ON_FAILURE)
