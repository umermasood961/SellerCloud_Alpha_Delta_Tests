...
WebUI.selectOptionByValue(findTestObject('Ship_withoutPay/select_SelectAction'), '181477', false)
...
if (Output.contains('Selected orders cannot be shipped until payment is made')) {
    ...
    KeywordUtil.markFailed('Failed due to setting disabled on client or company level')
}
