...
WebUI.setText(findTestObject('Orders_Alpha_CreateNew/Page_Shipping_Mthd/input_Shipping Price_txtShippingCost'), '5')
...
WebUI.click(findTestObject('Ship_withoutPay/a_Orders'))

WebUI.waitForPageLoad(3)

WebUI.click(findTestObject('Ship_withoutPay/input_btnSearch'))

WebUI.click(findTestObject('Ship_withoutPay/input_SelectCheckBox'))

WebUI.click(findTestObject('Ship_withoutPay/select_SelectAction'))

WebUI.selectOptionByValue(findTestObject('Ship_withoutPay/select_SelectAction'), '181478', false)

WebUI.click(findTestObject('Ship_withoutPay/input_ClickGoBtn'))

WebUI.waitForJQueryLoad(0)

Output = WebUI.getText(findTestObject('Ship_withoutPay/div_getMsg'))

if (Output.contains('Selected orders can now ship without payment')) {
    println('Success' //Output.contains('not updated because setting AllowShippingUnpaidOrders disabled on client or company level')
        )
} else {
...
WebUI.selectOptionByValue(findTestObject('Ship_withoutPay/select_SelectAction'), '2106', false)

WebUI.click(findTestObject('Ship_withoutPay/input_ClickGoBtn'))

WebUI.waitForPageLoad(3)

WebUI.click(findTestObject('Ship_withoutPay/Page_SellerCloud/input_selectOrderforShip'))

WebUI.click(findTestObject('Ship_withoutPay/Page_SellerCloud/input_btnSaveShipping'))

Status = WebUI.getText(findTestObject('Ship_withoutPay/Page_SellerCloud/div_GetInfo'))

WebUI.click(findTestObject('Ship_withoutPay/Page_SellerCloud/a_selectOrder'))

Ship_Status = WebUI.getText(findTestObject('Ship_withoutPay/Page_SellerCloud/span_FullyShipped'))

WebUI.waitForJQueryLoad(2)

WebUI.click(findTestObject('Ship_withoutPay/Page_Order 5074141/select_ActionSelect'))

WebUI.selectOptionByValue(findTestObject('Ship_withoutPay/Page_Order 5074141/select_ActionSelect'), '4001', false)

WebUI.click(findTestObject('Ship_withoutPay/Page_Order 5074141/input_GoBtn'))

WebUI.getText(findTestObject('Ship_withoutPay/Page_Order 5074141/Div_unshipNotification'))

WebUI.click(findTestObject('Ship_withoutPay/Page_Order 5074141/Click_ContineBtn'))

WebUI.getText(findTestObject('Ship_withoutPay/Page_Order 5074141/div_Order marked as unshipped'))
