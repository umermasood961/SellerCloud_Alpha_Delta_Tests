...
WebUI.click(findTestObject('Calculations verifications/Page_GetIntValues/ShippingDiscountsField'))

WebUI.setText(findTestObject('Calculations verifications/Page_GetIntValues/ShippingDiscountsField'), '')

WebUI.setText(findTestObject('Calculations verifications/Page_GetIntValues/ShippingDiscountsField'), '2')
...
Subtotal = WebUI.getText(findTestObject('Page_Newmthm/SubTotal'))

ShippingDiscount = WebUI.getText(findTestObject('Page_Newmthm/shipDiscount'))
