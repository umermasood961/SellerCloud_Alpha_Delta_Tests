...
'add wrong product id here'
WebUI.setText(findTestObject('Orders_Alpha_CreateNew/Page_SellerCloud_Orders/input_ProductId_ForOrder_Product'), '#666')
...
if (exceptions.contains('Invalid product id.')) {
	println('Right Exception')
} else {
	exceptions.contains('Error')

	KeywordUtil.markFailed('Failed due to Other exceptions')
}
