...
Notification_msg = WebUI.getText(findTestObject('Page_CaseQty/div_Per case Qty enabled'))

WebUI.click(findTestObject('Page_CaseQty/Page_CaseQty_dtl/a_OrderDtl'))

WebUI.waitForPageLoad(3)

Product_Qty = WebUI.getText(findTestObject('Page_CaseQty/Page_CaseQty_dtl/Product_qty'))

Case_Qty = WebUI.getText(findTestObject('Page_CaseQty/Page_CaseQty_dtl/Case_qty'))

Case_Price = WebUI.getText(findTestObject('Page_CaseQty/Page_CaseQty_dtl/Case_price'))