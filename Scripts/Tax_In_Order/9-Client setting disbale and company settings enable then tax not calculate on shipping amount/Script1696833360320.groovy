...
WebUI.click(findTestObject('Edit_TaxWork/CheckorUncheckState'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementChecked(findTestObject('Edit_TaxWork/CheckorUncheckState'), 0)
